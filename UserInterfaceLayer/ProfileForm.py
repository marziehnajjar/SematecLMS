...
class ProfileUI:
    ...
    def profileFormLoad(self):
        ...
        profilefrm.geometry('410x340')
        profilefrm.resizable(None, None)
        positionRight = int(profilefrm.winfo_screenwidth() / 2 - 410 / 2)
        positionDown = int(profilefrm.winfo_screenheight() / 2 - 3400 / 2)
...
# region Widgets ...
        ...
        lblLastLogin.grid(row=5, column=0, padx=10, pady=10, sticky='w')
        txtLastLogin = StringVar()
        entLastLogin = Entry(frameinfo, textvariable=txtLastLogin, width=40, highlightthickness=1)
        entLastLogin.grid(row=5, column=1, padx=10, pady=10, sticky='w')
        ...
        btnClose = Button(profilefrm, text='Close', width=20, relief='groove', command=CloseCommand)
